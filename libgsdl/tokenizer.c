 ...
 *
 * There are some quirks to the kinds of tokens generated by this tokenizer, due to the complexity
 * of SDL's numeric types. Namely, a single %T_NUMBER may become any number of other types depending
 * on whether it is preceded by a '.' or followed by a '/', ':' or alphanumeric suffix. For example,
 * "2007/04/19" is tokenized as:
 *
 * <informalexample>
 *   <programlisting>
 *     T_DATE_PART: "2007"
 ...
 * </informalexample>
 *
 * "502.6D", on the other hand, becomes:
 *
 * <informalexample>
 *   <programlisting>
 *     T_NUMBER: "502"
 ...
 * </informalexample>
 *
 * This was done to reduce the intelligence required in the tokenizer.
 */
...
/**
 * gsdl_tokenizer_get_filename:
 * @self: A valid %GSDLTokenizer.
 *
 * Returns: the name of the file being parsed by this %GSDLTokenizer. May be "&lt;string&gt;".
 */
 ...
 * @self: A valid %GSDLTokenizer.
 *
 * Frees this %GSDLTokenizer and all resources associated with it.
 */
...
/**
 * gsdl_token_type_name:
 * @token_type: A valid %GSDLTokenType.
 *
...
/*
 * _maketoken:
 * @type: A valid %GSDLTokenType.
 * @line: Line where the token occurred.
 * @col: Column of the start of the token.
 *
 * Returns: A newly-allocated %GSDLToken with the given information.
 */
