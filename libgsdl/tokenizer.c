...
/**
 * SECTION:gsdl-tokenizer
 * @short_description: Internal tokenizer for SDL format.
 *
 * This the tokenizer used by %GSDLParser. It should never be needed in external code, but is made
